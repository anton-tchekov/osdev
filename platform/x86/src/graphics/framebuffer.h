...
void framebuffer_circle_outline(Framebuffer *fb, i32 sx, i32 sy, i32 r, i32 ir,
	Color c, Color fill);

void framebuffer_round_rect_outline(Framebuffer *fb, i32 x, i32 y, i32 w, i32 h,
	i32 r, i32 t, Color color, Color fill);

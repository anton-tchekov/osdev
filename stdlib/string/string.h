...
/**
@brief Compares the first n bytes of two memory blocks pointed to by the provided pointers.
@param ptr1 A pointer to the first memory block.
@param ptr2 A pointer to the second memory block.
@param n The number of bytes to compare.
@return An integer less than, equal to, or greater than zero, indicating whether the first n bytes of the memory blocks pointed to by ptr1 and ptr2 are less than, equal to, or greater than each other, respectively.
 */
i32 memcmp(const void *ptr1, const void *ptr2, u32 count);

/**
@brief Searches for the first occurrence of a specific character in the first n bytes of the memory block pointed to by the provided pointer.
...
@return A pointer to the first occurrence of the character, if found, or a null pointer if the character is not found in the first n bytes of the memory block.
 */
 ...
 * This function copies the content of the null-terminated string pointed to by
 @p src to the buffer pointed to by @p dest,
 ...
 * to by @p str, not including the null terminator.
 */
 ...
 * @return A negative value if the first character that does not match has a lower value in @p str1 than in @p str2,
 *  a positive value if the first character that does not match has a greater value in @p str1 than in @p str2,
 *  or zero if the contents of both strings are equal.
 */
...
@return Pointer to the first occurrence of @p c in @p str, or NULL if @p c is not found.
This function searches for the first occurrence of the character @p c in the null-terminated string pointed to by @p str.
If @p c is found in @p str, the function returns a pointer to the first occurrence of @p c in @p str.
If @p c is not found in @p str, the function returns NULL.
 */
